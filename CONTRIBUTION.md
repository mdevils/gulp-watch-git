...
This document describes some points about contribution process for gulp-watch-git package.

The maintainer of the project is Marat Dulin (mdevils@yandex.ru).
